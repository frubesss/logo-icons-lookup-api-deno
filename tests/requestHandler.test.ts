...
Deno.test("returns 500 response when no valid path provided", async () => {
...
Deno.test("returns 500 response when lookup_logo path is called with no logoName query parameter", async () => {
...
Deno.test("returns 500 when logo is found but size query parameter is over the required bounds", async () => {
  const request = new Request(
...
Deno.test("returns 500 when logo is found but size query parameter is under the required bounds", async () => {
  const request = new Request(
